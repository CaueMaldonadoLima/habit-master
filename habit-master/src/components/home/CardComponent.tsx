...
export default function CardComponent({type} : Props) {
    ...
    return (
        <>
        {type == 'Create' &&
            <button onClick={() => handleClick('home/habits/create')} disabled={sending} className='btn w-full px-2 py-4 rounded-3xl h-full shadow-lg border-4 border-primary border-opacity-35 bg-base-100 space-y-4'>
        ...
        {type == 'Visualize' &&
            <button className='btn w-full px-2 py-4 rounded-3xl h-full shadow-lg border-4 border-primary border-opacity-35 bg-base-100 space-y-4'>
                <div id='title' className='flex space-x-2 w-full items-center justify-center'>
